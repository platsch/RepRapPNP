		...
		union(){
			hull(){
				translate([-x_carriage_body_length/2,x_carriage_body_width/2-wall,x_carriage_body_height/2-wall])
					rotate([0,90,0])
						cylinder(r=wall,h=x_carriage_body_length/2+extruder_mount_screw_washer_dia/2);
				translate([-x_carriage_body_length/2,x_carriage_body_width/2-wall,-x_carriage_body_height/2+wall])
					rotate([0,90,0])
						cylinder(r=wall,h=x_carriage_body_length/2+extruder_mount_screw_washer_dia/2);
			...
			mirror([0,1,0])
				hull(){
					...
					translate([-x_carriage_body_length/2,x_belt_pulley_dia/2-belt_tensioning_screw_dia/2-clearance-wall,x_carriage_body_height/2-wall])
						cube([x_carriage_body_length/2+extruder_mount_screw_washer_dia/2,wall,wall]);
			...
			difference(){
				translate([-x_carriage_body_length/2,-x_rod_dist/2,-x_carriage_body_height/2])
					cube([x_carriage_body_length/2+extruder_mount_screw_washer_dia/2,x_rod_dist,x_carriage_body_height]);
				hull(){
			...
			translate([-x_carriage_body_length/2,-x_carriage_body_width/2,x_carriage_body_height/2-wall-1])
				cube([x_carriage_body_length/2+extruder_mount_screw_washer_dia/2,wall,extruder_mount_screw_washer_dia+wall+1]);
			translate([-x_carriage_body_length/2,-x_carriage_body_width/2+wall+extruder_back_body_length-wall-clearance-extruder_mount_screw_nut_height-clearance-wall,x_carriage_body_height/2-wall-1])
				cube([x_carriage_body_length/2+extruder_mount_screw_washer_dia/2,wall+clearance+extruder_mount_screw_nut_height+clearance+wall,extruder_mount_screw_washer_dia+wall+1]);
			...
			translate([0,x_rod_dist/2,0])
				for(i=[0,1])
					mirror([0,i,0])
						rotate([-i*90,0,0])
							translate([-x_carriage_body_length/4,-linear_bearing_dia/2-clearance-wall+(frame_cable_mount_zip_tie_width+2*wall)/2,-x_carriage_body_height/2])
								difference(){
									hull(){
