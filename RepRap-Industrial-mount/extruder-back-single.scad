...
// RENDERING
rotate([90,0,0]) extruder_back_single();

module extruder_back_single(){
	difference(){
		extruder_back();
		translate([-60-extruder_mount_screw_washer_dia/2,0,0])cube(size=[60,60,60], center=false);
	}
}
...
module extruder_back(){
	difference(){
		...
		union(){
			...
			// extruder body
			for(i=[0,1]) translate([extruder_back_body_width/2-i*extruder_back_body_width,0,0]) mirror([i,0,0]) hull(){
			...
			translate([extruder_back_body_width-extruder_mount_screw_washer_dia/2,0,0])hull(){
		...
		for(i=[0]) translate([extruder_back_body_width/2-i*extruder_back_body_width,0,0]) mirror([i,0,0]){
			// extruder mount x-carriage clearance
			translate([-extruder_back_body_width/2-1-extruder_mount_screw_washer_dia/2,extruder_back_body_length-(wall+clearance+extruder_mount_screw_nut_height+clearance+wall),-1])
				cube([extruder_back_body_width+2+extruder_mount_screw_washer_dia,wall+clearance+extruder_mount_screw_nut_height+clearance+wall+1,extruder_mount_screw_washer_dia+clearance+1]);
			...
			translate([-extruder_back_body_width/2,-1,extruder_back_body_height-extruder_mount_screw_washer_dia/2])
				rotate([-90,0,0])
					cylinder(r=extruder_idler_hinge_screw_dia/2+clearance,h=extruder_back_body_length+2);
			translate([-extruder_back_body_width/2,extruder_back_body_length/2+(extruder_idler_hinge_screw_length-extruder_idler_hinge_screw_nut_height-clearance-extruder_idler_body_length-clearance),extruder_back_body_height-extruder_mount_screw_washer_dia/2])
				rotate([90,0,0])
					nut_trap(extruder_idler_hinge_screw_head_wrench,extruder_back_body_length);
		...
		translate([extruder_back_body_width-extruder_mount_screw_washer_dia/2,0,0]){
			difference(){
				union(){
